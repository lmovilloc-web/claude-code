...
insert into users (name, rut, email, role, truck_id) values
  ('Luis Movillo', '12.345.678-5', 'luis@ctruck.cl',   'admin',  null),
  ('Pedro Soto',   '14.567.890-3', 'pedro@ctruck.cl',  'driver', (select id from trucks where code = 'CTR-001')),
  ('Juan Fuentes', '15.678.901-1', 'juan@ctruck.cl',   'driver', (select id from trucks where code = 'CTR-002')),
  ('Marcos Rivas', '16.789.012-K', 'marcos@ctruck.cl', 'driver', (select id from trucks where code = 'CTR-003')),
  ('Diego Ulloa',  '17.890.123-8', 'diego@ctruck.cl',  'driver', (select id from trucks where code = 'CTR-004')),
  ('Camilo Peña',  '19.012.345-6', 'camilo@ctruck.cl', 'helper', (select id from trucks where code = 'CTR-001')),
  ('Andrés Vidal', '19.123.456-4', 'andres@ctruck.cl', 'helper', (select id from trucks where code = 'CTR-002'));
